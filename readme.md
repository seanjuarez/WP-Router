...
Provides a simple API for mapping requests to callback functions. Created by [Flightless](http://flightless.us).
...
**Jonathan Brinley**
* http://twitter.com/jbrinley
* http://github.com/jbrinley

Donate: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=A69NZPKWGB6H2
